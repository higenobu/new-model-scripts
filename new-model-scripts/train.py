...
from utils import process_data_pipeline
...
def main(args):
	...
	for i in range(1, 8):
		df_list_trains.append(pd.DataFrame({"text": sentences_train_combined[i], "label": labels_train_combined[i]}))
		df_list_devs.append(pd.DataFrame({"text": sentences_dev_combined[i], "label": labels_dev_combined[i]}))
		df_list_tests.append(pd.DataFrame({"text": sentences_test_combined[i], "label": labels_test_combined[i]}))
