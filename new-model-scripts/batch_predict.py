...
if __name__ == '__main__':
	...
	parser.add_argument('--data_path', type=str, default='/home/alkalinemoe/psych_model_scripts/data')
	parser.add_argument('--model_name_or_path', type=str, default='/home/matsuo/tamodels/')
	parser.add_argument('--output_dir', type=str, default='/home/alkalinemoe/psych_model_scripts/output')
